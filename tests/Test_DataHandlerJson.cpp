...
TEST_CASE("CodeGen::JsonDataHandler", "[DataHandlerJson]")
{
    ...
    SECTION("ParseAndStringify")
    {
        std::string_view dataStr
            = R"({"aircrafts":[)"
              R"({"seen":2021112101,"addr":1,"hexaddr":[2,3,4,5,6,7,8],"flight":[99,10,11,12,13,14,15,16,17],"altitude":18,"groundSpeed":19,"track":20,"lat":21.000000,"lon":22.000000,"verticalRate":23,"messageCount":24,"odd_cprlat":25,"odd_cprlon":26,"odd_cprtime":0,"even_cprlat":27,"even_cprlon":28,"even_cprtime":0},)"
