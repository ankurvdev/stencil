    ...
    public ReflectionBase::ObjMarker
{
    ...
    //void                            ProductId(const shared_string& val) { _ProductId = val; }
    ...
    //void                            Repair(const bool& val) { _Repair = val; }
    ...
    //void                            ForceNonSD(const bool& val) { _ForceNonSD = val; }
    ...
    //void                            TargetVolume(const shared_string& val) { _TargetVolume = val; }
    ...
    //void                            User(const shared_string& val) { _User = val; }
