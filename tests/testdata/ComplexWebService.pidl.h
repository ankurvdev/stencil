...
struct KeywordS : public ReflectionBase::Interface<KeywordS>
{
    ...
    virtual tree<shared_string> Find(tree<shared_string> const& root, shared_string const& query, shared_string const& type) = 0;
    virtual tree<shared_string> Create(shared_string const& word, tree<shared_string> const& parent)                         = 0;
    virtual int32_t             Delete()                                                                                     = 0;
    virtual int32_t             Modify(shared_string const& word)                                                            = 0;
    virtual int32_t             SetParent(tree<shared_string> const& parent)                                                 = 0;
...
struct Content : public ReflectionBase::Interface<Content>
{
    ...
    virtual int32_t AddKeyword(tree<shared_string> const& keyword)    = 0;
    virtual int32_t RemoveKeyword(tree<shared_string> const& keyword) = 0;
...
struct Search : public ReflectionBase::Interface<Search>
{
    ...
    virtual std::vector<long> SearchByKeywords(std::vector<tree<shared_string>> const& keywords) = 0;
