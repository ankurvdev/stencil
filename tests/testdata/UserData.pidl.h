    ...
    public ReflectionBase::ObjMarker
{
    ...
    //void                            modified(const timestamp& val) { _modified = val; }
    ...
    //void                            creation(const timestamp& val) { _creation = val; }
    ...
    public ReflectionBase::ObjMarker
{
    ...
    //void                            username(const ::Database2::ChildRef<Database2::WideString>& val) { _username = val; }
    ...
    //void                            password(const ::Database2::ChildRef<Database2::WideString>& val) { _password = val; }
    ...
    //void                            privatekey(const ::Database2::ChildRef<Database2::WideString>& val) { _privatekey = val; }
    ...
    //void                            clientcert(const ::Database2::ChildRef<Database2::WideString>& val) { _clientcert = val; }
    ...
    //void                            secretcode(const ::Database2::ChildRef<Database2::WideString>& val) { _secretcode = val; }
    ...
    public ReflectionBase::ObjMarker
{
    ...
    //void                            name(const ::Database2::ChildRef<Database2::WideString>& val) { _name = val; }
    ...
    //void                            uri(const ::Database2::ChildRef<Database2::WideString>& val) { _uri = val; }
    ...
    //void                            identity(const ::UuidBasedId<Identity::Data>& val) { _identity = val; }
