...
{
    using TObj = CLOpts1::CommandLineOptions;
    enum class Fields
    {
        Invalid,
...
,        Field_out_dir
    ...
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Key key)
    {
        switch (key)
        {
        case Fields::Field_workingDirectory: return false;
        case Fields::Field_libraries: return false;
        case Fields::Field_scan: return false;
        case Fields::Field_httpsPort: return true;
        case Fields::Field_daemon: return true;
        case Fields::Field_quiet: return true;
        case Fields::Field_out_dir: return true;
    ...
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_workingDirectoryT /* key */) { return false; }
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_librariesT /* key */) { return false; }
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_scanT /* key */) { return false; }
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_httpsPortT /* key */) { return true; }
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_daemonT /* key */) { return true; }
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_quietT /* key */) { return true; }
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_out_dirT /* key */) { return true; }
};
template <>
...
,        Field_field2
    ...
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Key key)
    {
        switch (key)
        {
        case Fields::Field_field1: return false;
        case Fields::Field_field2: return false;
        case Fields::Invalid: [[fallthrough]];
        default: break;
        }
        return false;
    ...
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_field1T /* key */) { return false; }
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_field2T /* key */) { return false; }
};
template <>
...
{
    using TObj = CLOpts1::ObjWithList;
    enum class Fields
    {
        Invalid,
        Field_field1
...
,        Field_key2
    ...
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Key key)
    {
        switch (key)
        {
        case Fields::Field_key1: return false;
        case Fields::Field_listofint: return false;
        case Fields::Field_listoflist: return false;
        case Fields::Field_listofobj: return false;
        case Fields::Field_objoflist: return false;
        case Fields::Field_key2: return false;
        case Fields::Invalid: [[fallthrough]];
        default: break;
        }
        return false;
    ...
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_key1T /* key */) { return false; }
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_listofintT /* key */) { return false; }
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_listoflistT /* key */) { return false; }
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_listofobjT /* key */) { return false; }
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_objoflistT /* key */) { return false; }
    static constexpr bool HasDefaultValueForKey(TObj const& /* obj */, Field_key2T /* key */) { return false; }
};
template <>
