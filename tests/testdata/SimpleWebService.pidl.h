...
struct Data : public ReflectionBase::ObjMarker
{
    ...
    static constexpr std::string_view FieldAttributeValue(FieldIndex index, const std::string_view& key)
    {
        switch (index)
        {
        case FieldIndex::randomInteger: return ::ReflectionServices::EmptyAttributeValue(key);
        case FieldIndex::randomString: return ::ReflectionServices::EmptyAttributeValue(key);
        default: break;
        }
...
struct TestInterface : public ReflectionBase::Interface<TestInterface>
{
    ...
    virtual Data::Data Create(int32_t const& randomInteger, shared_string const& randomString) = 0;
...
template <> struct ReflectionBase::TypeTraits<SimpleWebService::TestInterface_Create_Args&>
{
    ...
    using Handler = ::ReflectionServices::
        ReflectedStructHandler<SimpleWebService::TestInterface_Create_Args, Traits_arg_randomInteger, Traits_arg_randomString>;
};
template <> struct ReflectionBase::InterfaceTraits<SimpleWebService::TestInterface>
{
    ...
    using Apis = ::ReflectionBase::InterfaceApiPack<ApiTraits_Create>;
};

template <> struct ReflectionBase::InterfaceApiTraits<ReflectionBase::InterfaceTraits<SimpleWebService::TestInterface>::ApiTraits_Create>
{
    using ArgsStruct = SimpleWebService::TestInterface_Create_Args;
    static constexpr bool             IsStatic() { return false; }
    static constexpr std::string_view Name() { return "Create"; }

    static auto Invoke(ArgsStruct& args) { return args.instance->Create(args.get_arg_randomInteger(), args.get_arg_randomString()); }
};
...
template <> struct ReflectionBase::TypeTraits<SimpleWebService::Data::Data&>
{
    ...
    using Handler = ::ReflectionServices::ReflectedStructHandler<SimpleWebService::Data::Data, Traits_randomInteger, Traits_randomString>;
};
