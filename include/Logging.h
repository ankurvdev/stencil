...
namespace Logging
{
    ...
    class memstream : public memstreambuf<N>, public std::ostream
    {
    public:
    ...
    template <typename TraceTraits, typename... TArgs>
    void Log(const CorrelationVector & /*cv*/, TArgs &&... args)
    {
    ...
    struct Exception : public std::exception
    {
        ...
        Exception(const CorrelationVector & /*cv*/, TArgs &&... args) : std::exception()
        {
    ...
    template <>
    struct PrettyPrinter<std::string_view>
    {
    ...
    template <>
    struct PrettyPrinter<shared_string>
    {
    ...
    template <>
    struct PrettyPrinter<shared_wstring>
    {
